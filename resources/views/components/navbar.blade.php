    <nav>
      <ul>
        ...
        <li class=" dropdown">
          ...
          <ul class="dropdown-menu dropdown-custom ">
            <li><a class="text-dark dropdown-item " href="{{route('dashboard', Auth::user())}}">Profilo</a></li>
            <hr class="dropdown-divider">
            
            <li><a class="text-dark dropdown-item " onclick="event.preventDefault(); document.querySelector('#form-logout').submit();">Log-Out</a>
