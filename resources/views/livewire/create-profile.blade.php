<div>
    <form class=" rounded bg-form p-5 shadow" wire:submit="createProfile">
        <div class="mb-3">
            <label for="name" class="form-label font-gen">Nome</label>
        ...
        <div class="mb-3">
            <label for="surname" class="form-label font-gen">Cognome</label>
        ...
        <div class="mb-3">
            <label for="brithdate" class="form-label font-gen">Data di nascita</label>
        ...
        <div class="mb-3">
            <label for="phone_number" class="form-label font-gen">Numero di telefono</label>
        ...
        <div class="mb-3">
            <label for="address" class="form-label font-gen">Indirizzo</label>
        ...
        <div class="mb-3">
            <label for="city" class="form-label font-gen">Citta</label>
        ...
        <div class="mb-3">
            <label for="country" class="form-label font-gen">Paese</label>
        ...
        <div class="mb-3">
            <label for="postal_code" class="form-label font-gen">Codice di Avviamento Postale</label>
